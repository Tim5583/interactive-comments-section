        ...
        {replies && (
             <div className={classes.cardReply}>
                ...
                <div className={classes.replyContainer}>            
                    {replies.map(item => <Card cardata={item} isreply={true} key={item.id} currentUser={currentUser} onReply={onReply} onVoteChange={onVoteChange} onDelete={onDelete} onUpdate={onUpdate}/>)}
                </div>
            </div>
        )}
        </>
